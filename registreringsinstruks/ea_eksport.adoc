...
'''
.Illustrasjon av Obekttype KystkonturTekniskAnlegg registrert for teknisk anlegg selv om teknisk anlegg er under minstemål i FKB-BygnAnlegg
image::figurer/KaiBrygge1_BygnAnlegg_Vann.png[link=figurer/KaiBrygge1_BygnAnlegg_Vann.png, Alt="Illustrasjon av Obekttype KystkonturTekniskAnlegg registrert for teknisk anlegg selv om teknisk anlegg er under minstemål i FKB-BygnAnlegg"]
